...
DEBUG = config('DEBUG', default=False, cast=bool) #config('DEBUG', default=False, cast=bool)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context-processor.get_vendor',
                'accounts.context-processor.get_google_api',
